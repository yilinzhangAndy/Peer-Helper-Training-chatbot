...
from llama3_integration import Llama3ChatbotPipeline

# Page configuration
st.set_page_config(
    page_title="MAE Peer Advisor Training System (Llama 3.1)",
    page_icon="🦙",
    layout="wide",
...
def load_components():
    ...
    try:
        ...
        # Load Llama 3.1 chatbot pipeline
...
def main():
    ...
    st.markdown('<div class="llama-badge">🦙 Powered by Llama 3.1 8B Instruct - 100% Free & Local</div>', unsafe_allow_html=True)
    ...
    <div class="performance-info">
        ...
        <ul>
            <li><strong>Quality:</strong> Near GPT-3.5 level performance</li>
            <li><strong>Cost:</strong> Completely free after initial setup</li>
            <li><strong>Privacy:</strong> All processing happens locally</li>
            <li><strong>Speed:</strong> Fast responses with local inference</li>
        </ul>
    </div>
    """, unsafe_allow_html=True)
    ...
    if not all([intent_classifier, spm, pipeline]):
        ...
        st.info("💡 Make sure you have installed Llama 3.1 by running: python setup_llama3.py")
        return
    ...
    with st.sidebar:
        ...
        # Llama 3.1 info
        st.header("🦙 Llama 3.1 Features")
        st.markdown("""
        - ✅ **High Quality**: Near GPT-3.5 performance
        - ✅ **Completely Free**: No API costs
        - ✅ **Local Processing**: Privacy protected
        - ✅ **Fast Responses**: Optimized for dialogue
            ...
            if advisor_input.strip():
                ...
                with st.spinner("🦙 Llama 3.1 is thinking..."):
                    try:
                        ...
                        # Generate student reply using Llama 3.1
